...
| **Total** | **58** | **35,805** | **1,050** | 934 unit + 25 doc + 91 validation tests |
...
## Supplementary Note 5: Validation Report — phylip-rs vs PHYLIP 3.697
...
- **PHYLIP C comparison details**: For each of 27 compared programs (dnadist, neighbor, dnapars, dnapenny, dnaml, dnamlk, dnacomp, dnainvar, fitch, kitsch, protdist, protpars, seqboot, consense, treedist, clique, dollop, dolpenny, mix, penny, pars, gendist, restdist, contml, contrast, proml, promlk), the report documents input data, PHYLIP stdin commands, expected and actual output values, tolerances, and pass/fail status
...
The 91 validation tests are organized into four test files:
...
| validation_phylip | 33 | Direct comparison against PHYLIP 3.697 C executables on identical inputs |
...
*Full report: validation/VALIDATION_REPORT.md*
