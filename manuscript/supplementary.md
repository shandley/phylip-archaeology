...
| **Total** | **58** | **35,805** | **1,047** | 934 unit + 25 doc + 88 validation tests |
...
- **PHYLIP C comparison details**: For each of 24 compared programs (dnadist, neighbor, dnapars, dnapenny, dnaml, dnamlk, dnacomp, dnainvar, fitch, kitsch, protdist, protpars, seqboot, consense, treedist, clique, dollop, mix, penny, pars, gendist, restdist, contml, contrast), the report documents input data, PHYLIP stdin commands, expected and actual output values, tolerances, and pass/fail status
...
The 88 validation tests are organized into four test files:
...
| validation_phylip | 30 | Direct comparison against PHYLIP 3.697 C executables on identical inputs |
